...
namespace sfcat
{
    ...
    {
        public UpdateEntityCommand(string entityType, Dictionary<string, string> switches = null, ISchemaChecker checker = null) 
        ...
        {            
            try
            {
                ...
                if (intention != null)
                    return intention;
                CatalogServiceClient.CatalogServiceClient.PostEntityAsync(mySwitches["CatalogServiceEndpoint"], mEntityType, mySwitches["id"], content).Wait();                
